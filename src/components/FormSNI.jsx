...
import { deleteData, deleteRows } from "../redux/actions/sni";
...
const FormSNI = (props) =>{
    ...
    const rows = useSelector((state)=>state.sniReducer.rows);
    ...
    const obtenerData = async() =>{
        await axios.get('http://localhost:8080/api/sni/all',
    ...
    const postData = async(input)=>{
        await axios.post(
            'http://localhost:8080/api/sni/save', 
