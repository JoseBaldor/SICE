...
import { deleteData, deleteRows } from "../redux/actions/semestres";
import Botones from "./Botones";
import { useEffect, useState } from "react";
import { DataTable } from "./DataTable";

const FormSemestres =(props) => {
    const rows = useSelector((state)=>state.semestresReducer.rows);
    ...
    const postData = async(input)=>{
        await axios.post(
            'http://localhost:8080/api/semestres/save', 
    ...
    return(
        ...
        <form id={props.name} className={s.formulario} onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
                ...
                <input
                placeholder="Descripción Semestre..."
